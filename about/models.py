...
class Application(models.Model):
  ...
  graders = models.CharField(max_length=140, default='') #this is very sketchy - format is username,username,
  num_graders = models.DecimalField(max_digits=1, decimal_places=0, default=0) #max = 2
  comments = models.TextField(default='')

  status = models.CharField(max_length=30, default='N/A') # Accepted, Rejected, Waitlisted
